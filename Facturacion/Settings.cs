...
namespace Facturacion
{
    ...
    public static class Serilog
    {
        ...
        {
            string logPath = Path.Combine("../", $"{AppDomain.CurrentDomain.FriendlyName}-Logs.log");
            ...
            return new LoggerConfiguration()
                ...
                .WriteTo.File(logPath, LogEventLevel.Error, outputTemplate: Template);
        }
    }
    ...
    public static class DotEnv
    {
        ...
        {
            FilePath = Settings.IsDevelopingMode() ? Path.Combine("../../../..", filepath) : Path.Combine("../", filepath);
